...
Each node can only have one gear size associated with it.  That being said, in a multi-node setup you would edit the above file and specify the gear name and then modify the parameters to match the sizing you would like.
